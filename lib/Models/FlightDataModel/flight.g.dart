...
Flight _$FlightFromJson(Map<String, dynamic> json) => Flight(
      ...
      arrivalTimestamp: json['arrival_timestamp'] as num?,
      delay: json['delay'] as num?,
      departure: json['departure'] as String?,
      departureDate: json['departure_date'] as String?,
      departureTime: json['departure_time'] as String?,
      departureTimestamp: json['departure_timestamp'] as num?,
      duration: json['duration'] as num?,
      equipment: json['equipment'] as String?,
      localArrivalTimestamp: json['local_arrival_timestamp'] as num?,
      localDepartureTimestamp: json['local_departure_timestamp'] as num?,
